...
panel.to_csv('panel.csv',index=False, index_label=False)
del panel
...
balanced_panel.to_csv('balanced_panel.csv',index=False, index_label=False)
del balanced_panel
...
ub_panel.to_csv('ub_panel.csv',index=False,index_label=False)
del panel
del ub_panel
...
ub_panel1.to_csv('ub_panel1.csv',index=False,index_label=False)
ub_panel2=ub_panel[-ub_panel.id.isin(ub_length_year.index[ub_length_year==ub_gap_year])]
ub_panel2.to_csv('ub_panel2.csv',index=False,index_label=False)
del ub_panel
del ub_panel1
del ub_panel2